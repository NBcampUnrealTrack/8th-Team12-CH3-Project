...
void AVoxelChunkActor::BeginPlay()
{
	...
	//for (int32 Z = 0; Z < ChunkSizeZ; Z++) //-> �� Voxel���� �α����
	//{
...
FIntVector AVoxelChunkActor::GetDirectionOffset(EVoxelDirection Direction) const //FIntVector ���� ���� ����. 1*1*1 �׸��� ������.
{
	switch (Direction)
	{
	...
	// �����ϴ� ��� ���� switch ó�� - ���Ϲ�Ģ�̶� switch�� �δ� �� ������?
	checkNoEntry();//�ڵ尡 ������� �������� ����
	return FIntVector::ZeroValue; // ���������� �������� �ʴ� ���� ������ 000 ��ȯ
}

FVector AVoxelChunkActor::GetDirectionNormal(EVoxelDirection Direction) const //FIntVector ������ GetDirectionOffset�� FVector�� ��ȯ. Procedural Mesh���� Normal/Tangent��
{
